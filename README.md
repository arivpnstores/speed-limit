...
```bash
sudo curl -s https://raw.githubusercontent.com/arivpnstores/speed-limit/main/1hari-1TB.sh -o /usr/1hari-1TB.sh && sudo chmod +x /usr/1hari-1TB.sh && (crontab -l 2>/dev/null; echo "*/10 * * * * /usr/1hari-1TB.sh") | crontab -
```
